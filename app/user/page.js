...
export default function UserDashboard() {
  ...
  useEffect(() => {
    ...
    if (userData) {
      setManualUser(JSON.parse(userData));
    }
    setIsLoading(false);
  }, []);
  ...
  useEffect(() => {
    if (status === "unauthenticated") {
      // Cek localStorage untuk login manual
                ...
                <div className="flex items-center space-x-3">
                  <div className="flex items-center space-x-3">
                    <div className="h-10 w-10 bg-gradient-to-br from-[#00a8cc] to-[#0095b8] rounded-full flex items-center justify-center text-white font-medium">
                      {session.user.name?.charAt(0)}{session.user.name?.charAt(0)}
                    </div>
                    <div>
    ...
    return (
      <div className="min-h-screen bg-gray-50">
            ...
            <div className="flex justify-between items-center h-16">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex items-center space-x-3">
                  <div className="flex items-center space-x-3">
                    <div className="h-10 w-10 bg-gradient-to-br from-[#00a8cc] to-[#0095b8] rounded-full flex items-center justify-center text-white font-medium">
                      {manualUser.firstName?.charAt(0) || manualUser.email?.charAt(0)}{manualUser.lastName?.charAt(0) || ''}
                    </div>
                    <div>
                      <p className="text-sm font-medium text-gray-900">
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          >
            <h2 className="text-3xl font-bold text-[#1a2a3a] mb-2">
              Selamat Datang, {manualUser.firstName || manualUser.email}!
            </h2>
            <p className="text-gray-600">
              Kelola kesehatan Anda dengan mudah dan terhubung dengan dokter terbaik.
            </p>
  ...
  // Jika tidak ada session dan tidak ada user manual, redirect ke login
  return null;
}
